...
In the Session X Done and Do table, you can see that for today, we joined the Microsoft Teams meeting invitation from Outlook and called in, if needed. Your home base is mtl.how for ALL of the tools and resources we'll use in _Modeling to Learn_, so if you ever forget a link or anything, just type mtl.how into your browser.
